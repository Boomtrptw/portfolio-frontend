...
import { FolderGit2, ArrowUpRight, Eye, ChevronDown, ChevronUp } from "lucide-react";

export default function ProjectsPage() {
  const [showDetail, setShowDetail] = useState(false);
  // ข้อมูลจำลองสำหรับ Template (เดี๋ยวคุณนำข้อมูลจริงมาทับตรงนี้ได้เลย)
  const myProjects = [
    {
            ...
            <div key={index} className="flex flex-col">
              ...
              <div className="group relative bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-[2.5rem] overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/10 border-b-4 hover:border-b-blue-600">
                <div className="grid grid-cols-1 md:grid-cols-2">
                  ...
                  {/* ฝั่งรูปภาพ */}
                  <div className="relative h-64 md:h-auto overflow-hidden bg-zinc-100 dark:bg-zinc-800">
                    <img
                      src={project.image}
                      alt={project.title}
                  ...
                  <div className="p-8 md:p-12 flex flex-col justify-center">
                    <div className="flex justify-between items-center mb-6">
                      <span className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-600 bg-blue-50 dark:bg-blue-900/20 px-3 py-1 rounded-full">
                    ...
                    <h3 className="text-3xl font-bold dark:text-white mb-4 group-hover:text-blue-600 transition-colors tracking-tight italic uppercase">
                      {project.title}
                    </h3>
                    ...
                    <div className="flex flex-wrap gap-2 mb-10">
                      {project.tech?.map((tag) => (
                        <span key={tag} className="px-3 py-1 bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-300 text-[10px] font-bold rounded-lg uppercase">
                          {tag}
                        </span>
                      ))}
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      ...
                      <button
                        ...
                        className={`flex-1 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 border ${showDetail
                          ...
                          : "bg-white dark:bg-zinc-900 text-zinc-900 dark:text-white border-zinc-200 dark:border-zinc-700 hover:bg-zinc-50"
                          }`}
                      >
                ...
                <div className="p-8 md:p-12 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-[2.5rem] shadow-inner">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left mb-16">
                    <div className="space-y-4">
                      ...
                      <p className="text-sm dark:text-zinc-400 leading-relaxed font-medium">
                        แก้ปัญหาการจดบันทึกด้วยมือ (Manual Paperwork) ที่ทำให้ข้อมูลการผลิตดีเลย์และเกิดความผิดพลาดสูง โดยเฉพาะการติดตามสถานะเครื่องจักรที่คลาดเคลื่อน
                      </p>
                    </div>
                    <div className="space-y-4">
                  ...
                  {/* 2. Technical Implementation (ส่วนที่เพิ่มใหม่) */}
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 pt-12 border-t border-zinc-100 dark:border-zinc-800">
                    <div className="space-y-6 text-left">
                      <h5 className="text-xl font-black dark:text-white italic uppercase tracking-tighter">Machine Intelligence & Tracking</h5>
                    ...
                    <div className="bg-zinc-50 dark:bg-zinc-800/50 p-6 rounded-3xl text-left border border-zinc-100 dark:border-zinc-700">
                      ...
                      <p className="text-xs dark:text-zinc-400 leading-relaxed mb-6">
                  ...
                  <div className="mt-12 pt-8 border-t border-zinc-100 dark:border-zinc-800">
                    <p className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.2em] mb-6 text-left">Engineered With</p>
                    <div className="flex flex-wrap gap-3">
                      {project.tech?.map(t => (
                        <div key={t} className="flex items-center gap-2 px-4 py-2 bg-zinc-50 dark:bg-zinc-800/80 text-zinc-700 dark:text-zinc-300 text-[10px] font-bold rounded-xl border border-zinc-100 dark:border-zinc-700 uppercase italic transition-colors hover:border-blue-500">
